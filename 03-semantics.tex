...
\end{alignat*}
\caption{ The abstract syntax of \CEU. }
\label{fig.sem.syntax}
\end{figure}
\egroup

Figure~\ref{fig.sem.syntax} defines the syntax of a subset of \CEU that is
...
%
Listing~\ref{lst.fin.a} shows the original program with an explicit block
...
%
The translation in Listing~\ref{lst.fin.b} also executes \code{<A>} (ln~1)
