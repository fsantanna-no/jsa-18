...
\begin{comment}
Although the abstract $\ceu{\AwaitInt}$ and~$\ceu{\EmitInt}$ do not support
such communication of values, it can be easily simulated: one can use a shared variable to hold the value of an
