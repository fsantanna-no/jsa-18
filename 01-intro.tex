...
%
Section~\ref{sec.ceu} is a review of the main characteristics of \CEU from
...
%
Section~\ref{sec.proofs} presents the proofs for memory boundedness,
deterministic execution, and terminating reactions for all programs in \CEU.
%
