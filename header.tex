...
\def\@ceu#1{%
  ...
  \def\Id{\mathit{id}}%             TO BE REMOVED
  \def\Mem{\@ceuop{mem}}%           TO BE REMOVED
  \def\Locals{\@ceuop{locals}}%     TO BE REMOVED
  \def\And{\@ceubin{and}}%          TO BE REMOVED
  \def\Or{\@ceubin{or}}%            TO BE REMOVED
  \def\CanRun{\@ceuop{@canrun}}%    TO BE REMOVED
  \def\Restore{\@ceuop{@restore}}%  TO BE REMOVED 
...
\newcommand*\eval{\mathop{\mathit{eval}}}
\newcommand*\isblk{\mathop{\mathit{isblk}}}
\newcommand*\reactspc{\mathop{\mathit{react}}\nolimits_\mathit{spc}}
\newcommand*\reaction{\mathop{\mathit{reaction}}}
\newcommand*\updt{\mathop{\mathit{updt}}}
...
\newcommand*\Rtag[1]{\tag{\@R{#1}}\label{R:#1}} % TO BE REMOVED
\makeatother
